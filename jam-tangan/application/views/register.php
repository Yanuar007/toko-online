        ...
        <div class="block xl:grid grid-cols-2 gap-4">
            ...
            <div class="hidden xl:flex flex-col min-h-screen">
                <a href="" class="-intro-x flex items-center pt-5">
                    ...
                    <span class="text-white text-lg ml-3"> Miskin Pride </span>
                </a>
                <div class="my-auto">
                    ...
                    <div class="-intro-x mt-5 text-lg text-white text-opacity-70 dark:text-slate-400">Panjang umur untuk
                        semua hal baik</div>
                </div>
            </div>
            <!-- END: Register Info -->
            ...
            <div class="h-screen xl:h-auto flex py-5 xl:py-0 my-10 xl:my-0">
                <div
                    ...
                    <div class="intro-x mt-2 text-slate-400 dark:text-slate-400 xl:hidden text-center">A few more clicks
                        to sign in to your account. Panjang umur untuk semua hal baik.</div>
