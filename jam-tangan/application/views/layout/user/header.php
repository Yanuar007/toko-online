...
<head>
    ...
    <title><?= $title ?> | Miskin Pride</title>
    <!-- BEGIN: CSS Assets-->
    ...
    <div class="mobile-menu md:hidden">
        <div class="mobile-menu-bar">
            <a href="" class="flex mr-auto">
                <img alt="Midone - HTML Admin Template" class="w-6" src="<?= site_url('asset') ?>">
            </a>
        ...
        <div class="h-full flex items-center">
            ...
            <a href="" class="-intro-x hidden md:flex">
                <div class="brand-icon">
                    <i class="fa-duotone fa-watch"></i>
                </div>
                <span class="text-white text-lg ml-3"> TIME | ZONE </span>
            </a>
            <!-- END: Logo -->
            <!-- BEGIN: Breadcrumb -->
            ...
            <div class="intro-x dropdown w-8 h-8">
                ...
                <div class="dropdown-menu w-56">
                    <ul class="dropdown-content bg-primary/80 before:block before:absolute before:bg-black before:inset-0 before:rounded-md before:z-[-1] text-white">
                        ...
                        <li>
                            <a href="<?= site_url('profile') ?>" class="dropdown-item hover:bg-white/5"> <i data-lucide="user" class="w-4 h-4 mr-2"></i> Profile Saya </a>
                        </li>
                        <li>
                            <a href="<?= site_url('change_password') ?>" class="dropdown-item hover:bg-white/5"> <i data-lucide="lock" class="w-4 h-4 mr-2"></i> Atur Ulang Kata Sandi </a>
                        </li>
                        <li>
                            <hr class="dropdown-divider border-white/[0.08]">
                        </li>
        ...
        <div class="wrapper-box">
            ...
            <nav class="side-nav">
                <ul>
                    ...
                    <li>
                        <a href="<?= base_url('kategori/chanel') ?>" class="side-menu">
                            <div class="side-menu__icon"> <i data-lucide="watch"></i> </div>
                            <div class="side-menu__title"> Chanel </div>
                        </a>
                    </li>
                    <li>
                        <a href="<?= base_url('kategori/danielwellington') ?>" class="side-menu">
                            <div class="side-menu__icon"> <i data-lucide="watch"></i> </div>
                            <div class="side-menu__title"> Daniel Wellington </div>
                        </a>
                    </li>

                    <li>
                        <a href="<?= base_url('kategori/gshock') ?>" class="side-menu">
                            <div class="side-menu__icon"> <i data-lucide="watch"></i> </div>
                            <div class="side-menu__title"> G-Shock </div>
                        </a>
                    </li>
                    ...
                    <li>
                        <a href="<?= base_url('bill') ?>" class="side-menu">
                            ...
                            <div class="side-menu__title"> Menunggu Pembayaran </div>
                        </a>
                    </li>
                    ...
                    <li>
                        <a href="<?= base_url('pay') ?>" class="side-menu">
                            <div class="side-menu__icon"> <i data-lucide="file-text"></i> </div>
                            <div class="side-menu__title"> History Pembayaran </div>
                        </a>
                    </li>
                    <li class="side-nav__devider my-6"></li>
                    <li>
