        ...
        <div class="wrapper-box">
            ...
            <nav class="side-nav">
                <ul>
                    ...
                    <li>
                        <a href="<?= base_url('categories/chanel') ?>" class="side-menu">
                            <div class="side-menu__icon"> <i data-lucide="watch"></i> </div>
                            <div class="side-menu__title"> Chanel </div>
                        </a>
                    </li>
                    <li>
                        <a href="<?= base_url('categories/danielwellington') ?>" class="side-menu">
                            <div class="side-menu__icon"> <i data-lucide="watch"></i> </div>
                    ...
                    <li>
                        <a href="<?= base_url('categories/gshock') ?>" class="side-menu">
                            <div class="side-menu__icon"> <i data-lucide="watch"></i> </div>
