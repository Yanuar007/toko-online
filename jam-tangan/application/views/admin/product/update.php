                                ...
                                <form action="<?= site_url('admin/product/insert_update') ?>" method="post">
                                    <div class="grid grid-cols-12 gap-x-5">
                                        <div class="col-span-12 2xl:col-span-6">
                                            <div>
                                                <label for="update-profile-form-1" class="form-label">Nama Produck</label>
                                            ...
                                            <div class="mt-3">
                                                ...
                                                <select id="category" name="kategori" class="form-select">
                                                    ...
                                                    <option value="Electronic">Danielwellington</option>
                                                    <option value="Kids &amp; Baby">G-Shock</option>
                                                </select>
                                            </div>
                                        </div>
                                        <div class="col-span-12 2xl:col-span-6">
                                            <div class="mt-3 2xl:mt-0">
                                                <label for="update-profile-form-3" class="form-label">Stock</label>
                                        ...
                                        <div class="col-span-12">
                                            <div class="mt-3">
                                                <label for="update-profile-form-5" class="form-label">Descripsi Produck</label>
                            ...
                            <div class="w-52 mx-auto xl:mr-0 xl:ml-6">
                                <div class="border-2 border-dashed shadow-sm border-slate-200/60 dark:border-darkmode-400 rounded-md p-5">
                                    ...
                                    <div class="mx-auto cursor-pointer relative mt-5">
                                        <button type="button" class="btn btn-primary w-full">Gambar Produck</button>
                                    </div>
                                </div>
                            </div>
                        <?php endforeach; ?>
