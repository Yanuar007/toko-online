           ...
           <div class="col-span-12 lg:col-span-4 2xl:col-span-3">
               <div class="box p-5 rounded-md">
                   ...
                   <div class="flex items-center"> <i data-lucide="clipboard" class="w-4 h-4 text-slate-500 mr-2"></i>
                       <b>Order ID:</b> <a href=""
                           class="underline decoration-dotted ml-1">#<?= $invoice->order_id ?></a> </div>
               ...
               <div class="box p-5 rounded-md mt-5">
                   ...
                   <div class="flex items-center"> <i data-lucide="clipboard" class="w-4 h-4 text-slate-500 mr-2"></i>
                       <b>Customer Name:</b> <a href=""
                           class="underline decoration-dotted ml-1"><?= $invoice->name ?></a> </div>
                   <div class="flex items-center mt-3"> <i data-lucide="calendar"
               ...
               <div class="box p-5 rounded-md mt-5">
                   ...
                   <div class="flex items-center"> <i data-lucide="clipboard" class="w-4 h-4 text-slate-500 mr-2"></i>
                       <b>Courier:</b>&nbsp; <?= $invoice->ekspedisi ?> </div>
                   <div class="flex items-center mt-3"> <i data-lucide="calendar"
                           class="w-4 h-4 text-slate-500 mr-2"></i> <b>Tracking Order:</b>&nbsp;
                       <?= $invoice->tracking_id ?> <i data-lucide="copy" class="w-4 h-4 text-slate-500 ml-2"></i>
                   </div>
                   <div class="flex items-center mt-3"> <i data-lucide="map-pin"
                           class="w-4 h-4 text-slate-500 mr-2"></i> <b>Address:</b>&nbsp; <?= $invoice->alamat ?>,
                       <?= $invoice->city ?>. </div>
               </div>
           </div>
