  <div class="content">
    <div class="intro-y flex flex-col sm:flex-row items-center mt-8">
        ...
        <div class="w-full sm:w-auto flex mt-4 sm:mt-0">
            <a href="<?= site_url('bill')?>" class="btn btn-primary shadow-md mr-2">History Pembayaran</a>
    ...
    <div class="intro-y box overflow-hidden mt-5">
        <div class="border-b border-slate-200/60 dark:border-darkmode-400 text-center sm:text-left">
            ...
            <div class="flex flex-col lg:flex-row px-5 sm:px-20 pt-10 pb-10 sm:pb-20">
                <div>
                    <div class="text-base text-slate-500">Detail Customer</div>
                ...
                <div class="lg:text-right mt-10 lg:mt-0 lg:ml-auto">
                    ...
                    <div class="text-lg font-medium text-primary mt-2">Miskin Pride</div>
                    <div class="mt-1">miskin.pride@begaduh.com</div>
                </div>
            </div>
        </div>
