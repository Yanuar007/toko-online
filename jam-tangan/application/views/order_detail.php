   <div class="content">
       <div class="intro-y flex flex-col sm:flex-row items-center mt-8">
           ...
           <div class="w-full sm:w-auto flex mt-4 sm:mt-0">
               <a href="<?= site_url('order') ?>" class="btn btn-danger shadow-md mr-2">History Pesanan</a>
           </div>
       </div>
       ...
       <div class="intro-y grid grid-cols-11 gap-5 mt-5">
           <div class="col-span-12 lg:col-span-4 2xl:col-span-3">
               ...
               <div class="box p-5 rounded-md mt-5">
                   ...
                   <div class="flex items-center mt-3"> <i data-lucide="calendar" class="w-4 h-4 text-slate-500 mr-2"></i> <b>Nomor Telpon:</b>&nbsp; <?= $invoice->mobile_phone ?> </div>
               </div>
               <div class="box p-5 rounded-md mt-5">
                   <div class="flex items-center border-b border-slate-200/60 dark:border-darkmode-400 pb-5 mb-5">
